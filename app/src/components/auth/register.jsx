      ...
      {showRegisterDropdown && (
        <div>
          <form
            ...
            className="relative z-50 p-8 bg-white rounded-lg shadow-lg w-[400px] max-w-md border border-neutral-400">
            <div className="flex items-center justify-start mb-4">
              <h1 className="text-2xl font-bold text-center flex-1 text-gray-800 mb-8">Registrieren</h1>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                name="vorname"
                placeholder="Vorname"
                className="w-full ml-0 p-3 text-sm text-gray-900 bg-gray-50 border border-neutral-400 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                required
