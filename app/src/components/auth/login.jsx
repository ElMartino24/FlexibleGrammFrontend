        ...
        <div>
          <form
            ...
            <div className="flex items-center justify-start mb-4">
              <h1 className="text-2xl font-bold text-center flex-1 text-gray-800 mb-6">Login</h1>
              <img src={XIcon} alt="X-Icon" className="w-[1rem] h-[1rem] cursor-pointer mb-6" onClick={handleXClick}/>
            </div>
            <div className="mb-4">
              ...
              <input
                ...
                name="email"
                placeholder="Email"
                className="w-full p-3 ml-0 text-sm text-gray-900 bg-gray-50 border border-neutral-400 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                required
            ...
            <div className="mb-4 relative">
              ...
              <input
                ...
                className="w-[100%] p-3 ml-0 text-sm text-gray-900 bg-gray-50 border border-neutral-400 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                required
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <a onClick={handleRegisterClick} className="text-sm text-purple-600 cursor-pointer hover:underline">
                Registrieren
              </a>
            </div>
            <button type="submit"
